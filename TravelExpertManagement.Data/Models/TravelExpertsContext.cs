...
public partial class TravelExpertsContext : IdentityDbContext<ApplicationUser>
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-NAGNK04T\\SQLEXPRESS;Initial Catalog=TravelExperts;Integrated Security=True; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PackageProductSupplierId).HasName("PK__Packages__53E8ED99792A8082");
        ...
        modelBuilder.Entity<ApplicationUser>().ToTable("AspNetUsers"); // Set the custom table name for users
        modelBuilder.Entity<IdentityRole>().ToTable("AspNetRoles"); // Set the custom table name for roles
        modelBuilder.Entity<IdentityUserRole<string>>().ToTable("AspNetUserRoles"); // Set the custom table name for user roles
        modelBuilder.Entity<IdentityUserClaim<string>>().ToTable("AspNetUserClaims"); // Set the custom table name for user claims
        modelBuilder.Entity<IdentityRoleClaim<string>>().ToTable("AspNetRoleClaims"); // Set the custom table name for role claims
        modelBuilder.Entity<IdentityUserLogin<string>>().ToTable("AspNetUserLogins"); // Set the custom table name for user logins
        modelBuilder.Entity<IdentityUserToken<string>>().ToTable("AspNetUserTokens"); // Set the custom table name for user tokens
